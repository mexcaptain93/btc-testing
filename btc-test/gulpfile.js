...
gulp.task('init', function() {
	const folders = ['build', 'build/css', 'build/img', 'build/img/svg', 'build/js', 'dev', 'dev/html', 'dev/html/includes', 'dev/js', 'dev/scss', 'dev/svg'];
	folders.forEach((f) => {
		createFolder(f);
	});
...
gulp.task('default', ['html', 'css', 'browser-sync', 'js'], function() {
	...
	gulp.watch("dev/scss/*.scss", ['bs-reload', 'css']);
